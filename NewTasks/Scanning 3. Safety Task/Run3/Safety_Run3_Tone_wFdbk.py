...
expName = 'Safety_Run3_Tone'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'run': '003',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/stashjian/Documents/Melbourne/Adolescent_Safety/SafetyTask_windows/AversiveTone/Run3/Safety_Run3_Tone.py',
...
trigger = visual.TextStim(win=win, name='trigger',
    text='Now you will play the third set of battles with animals and weapons…',
    font='Arial',
...
Loop = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('Battles_Run3_tone.xlsx'),
    seed=None, name='Loop')
