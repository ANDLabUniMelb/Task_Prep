...
expName = 'Safety_Run1_Tone'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'run': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/stashjian/Documents/Melbourne/Adolescent_Safety/SafetyTask_windows/AversiveTone/Run1/Safety_Run1_Tone.py',
...
trigger = visual.TextStim(win=win, name='trigger',
    text='Now you will play the first set of battles with animals and weapons…',
    font='Arial',
...
Loop = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('Battles_Run1_tone.xlsx'),
    seed=None, name='Loop')
