...
expName = 'Gen_Run3_Tone'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'run': '003',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/stashjian/Documents/Melbourne/Adolescent_Safety/GeneralizationTask_windows/Run3/Gen_Run3_Tone.py',
...
Block_H_Confidence_Resp = keyboard.Keyboard()
...
for thisFullLoop in FullLoop:
    ...
    for thisLoopH in loopH:
        ...
        # continueRoutine = True
        # # update component parameters for each repeat
        # Block_H_Confidence_Resp.keys = []
        # Block_H_Confidence_Resp.rt = []
        # _Block_H_Confidence_Resp_allKeys = []
        # # keep track of which components have finished
        # Block_HComponents = [Block_H_ITI, Block_H_Context, Block_H_Confidence, Block_H_Confidence_Resp]
        ...
        #     if Block_H_Confidence.status == STARTED:
        #         # is it time to stop? (based on global clock, using actual start)
        #         if tThisFlipGlobal > Block_H_Confidence.tStartRefresh + 7-frameTolerance:
        #             # keep track of stop time/frame for later
        ...
        #     # *Block_H_Confidence_Resp* updates
        #     waitOnFlip = False
            
        #     # if Block_H_Confidence_Resp is starting this frame...
        #     if Block_H_Confidence_Resp.status == NOT_STARTED and tThisFlip >= 5.5-frameTolerance:
        #         # keep track of start time/frame for later
        #         Block_H_Confidence_Resp.frameNStart = frameN  # exact frame index
        #         Block_H_Confidence_Resp.tStart = t  # local t and not account for scr refresh
        #         Block_H_Confidence_Resp.tStartRefresh = tThisFlipGlobal  # on global time
        #         win.timeOnFlip(Block_H_Confidence_Resp, 'tStartRefresh')  # time at next scr refresh
        #         # add timestamp to datafile
        #         thisExp.timestampOnFlip(win, 'Block_H_Confidence_Resp.started')
        #         # update status
        #         Block_H_Confidence_Resp.status = STARTED
        #         # keyboard checking is just starting
        #         waitOnFlip = True
        #         win.callOnFlip(Block_H_Confidence_Resp.clock.reset)  # t=0 on next screen flip
        #         win.callOnFlip(Block_H_Confidence_Resp.clearEvents, eventType='keyboard')  # clear events on next screen flip
            
        #     # if Block_H_Confidence_Resp is stopping this frame...
        #     if Block_H_Confidence_Resp.status == STARTED:
        #         # is it time to stop? (based on global clock, using actual start)
        #         if tThisFlipGlobal > Block_H_Confidence_Resp.tStartRefresh + 7-frameTolerance:
        #             # keep track of stop time/frame for later
        #             Block_H_Confidence_Resp.tStop = t  # not accounting for scr refresh
        #             Block_H_Confidence_Resp.frameNStop = frameN  # exact frame index
        #             # add timestamp to datafile
        #             thisExp.timestampOnFlip(win, 'Block_H_Confidence_Resp.stopped')
        #             # update status
        #             Block_H_Confidence_Resp.status = FINISHED
        #             Block_H_Confidence_Resp.status = FINISHED
        #     if Block_H_Confidence_Resp.status == STARTED and not waitOnFlip:
        #         theseKeys = Block_H_Confidence_Resp.getKeys(keyList=['a','b','c','d', 'A', 'B', 'C', 'D'], waitRelease=False)
        #         _Block_H_Confidence_Resp_allKeys.extend(theseKeys)
        #         if len(_Block_H_Confidence_Resp_allKeys):
        #             Block_H_Confidence_Resp.keys = [key.name for key in _Block_H_Confidence_Resp_allKeys]  # storing all keys
        #             Block_H_Confidence_Resp.rt = [key.rt for key in _Block_H_Confidence_Resp_allKeys]
        #             # a response ends the routine
        #             continueRoutine = False
        ...
        #         thisComponent.setAutoDraw(False)
        # # check responses
        # if Block_H_Confidence_Resp.keys in ['', [], None]:  # No response was made
        #     Block_H_Confidence_Resp.keys = None
        # loopH.addData('Block_H_Confidence_Resp.keys',Block_H_Confidence_Resp.keys)
        # if Block_H_Confidence_Resp.keys != None:  # we had a response
        #     loopH.addData('Block_H_Confidence_Resp.rt', Block_H_Confidence_Resp.rt)
        # # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        # if routineForceEnded:
        #     routineTimer.reset()
        # else:
        ...
        loop1 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('Battles_Run3_H.xlsx'),
        ...
        for thisLoop1 in loop1:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            firststim_img_loop1.setImage(FirstStimH)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim1_loop1.setImage(ConfidenceH)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            secondstim_img_loop1.setImage(SecondStimH)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim2_loop1.setImage(ConfidenceH)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            outcome_img_loop1.setImage(OutcomeH)
            Tone_loop1.setSound(ToneH, secs=1.3, hamming=True)
    ...
    for thisLoopL in loopL:
        ...
        loop2 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('Battles_Run3_L.xlsx'),
        ...
        for thisLoop2 in loop2:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            firststim_img_loop2.setImage(FirstStimL)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim1_loop2.setImage(ConfidenceL)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            secondstim_img_loop2.setImage(SecondStimL)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim2_loop2.setImage(ConfidenceL)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            outcome_image_loop2.setImage(OutcomeL)
            Tone_loop2.setSound(ToneL, secs=1.3, hamming=True)
    ...
    for thisLoopA in loopA:
        ...
        loop3 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('Battles_Run3_A.xlsx'),
        ...
        for thisLoop3 in loop3:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            firststim_img_loop3.setImage(FirstStimA)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim1_loop3.setImage(ConfidenceA)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            secondstim_img_loop3.setImage(SecondStimA)
            # keep track of which components have finished
            ...
            continueRoutine = True
            # update component parameters for each repeat
            conf_img_stim2_loop3.setImage(ConfidenceA)
            ...
            continueRoutine = True
            # update component parameters for each repeat
            outcome_img_loop3.setImage(OutcomeA)
            Tone_loop3.setSound(ToneA, secs=1.3, hamming=True)
